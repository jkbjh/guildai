...
- [`run`](project:/pages/commands/run.md) - Symbolic links are used when linking required resource files.
- [`tensorboard`](project:/pages/commands/tensorboard.md) - Symbolic links are used when constructing the TensorBoard log directory used to view selected runs.
...
- [Start a Command Prompt as an Administrator](https:/project:/pages/docs.microsoft.com/en-us/previous-versions/windows/it-pro/windows-server-2012-r2-and-2012/jj717276(v=ws.11.md)) (Microsoft Documentation)
- [Create symbolic links](https:/project:/pages/docs.microsoft.com/en-us/windows/security/threat-protection/security-policy-settings/create-symbolic-links.md) (Microsoft Documentation)
