...
Refer to [*Guild AI Commands*](project:/pages/commands.md) for a list of Guild AI commands.
...
Guild's primary interface is via the command line. Guild also supports a [Python interface](project:/pages/docs/python-api.md) for work in Jupyter Notebooks.
